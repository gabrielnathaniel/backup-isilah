...
class FirstWinMenu extends StatefulWidget {
  // An unique identified for this overlay.
  static const id = 'FirstWinMenu';

  // Reference to parent game.
  final RunningGame gameRef;
  final List<LevelGame>? levelGame;

  const FirstWinMenu(this.gameRef, {Key? key, required this.levelGame})
      : super(key: key);

  @override
  State<FirstWinMenu> createState() => _FirstWinMenuState();
}

class _FirstWinMenuState extends State<FirstWinMenu> {
