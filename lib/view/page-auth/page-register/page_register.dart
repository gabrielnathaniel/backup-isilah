...
import 'package:isilahtitiktitik/view/page-auth/page-register/page_register_last.dart';
...
/// User dapat mendaftar akun dengan mengisi data-data yang ada di page ini.
///
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                    ...
                    decoration: inputDecoration(Platform.isIOS
                    ...
                    if (Platform.isIOS) {
                      ...
                      auth
                          .postRegisterOne(
                              ...
                              basket['idProvince'] ?? 7,
                              basket['idCity'] ?? 65,
                              basket['idSubdistrict'] ?? 770,
                              basket['idUrbanVillage'] ?? 11182,
                              basket['postalCode'] == null
                                  ? "10220"
                        ...
                        if (value['status'] == 1) {
                          ...
                          setState(() {
                            postRegister = PostRegister(
                                ...
                                birthdate: textEditingTglLahir.text.isEmpty
                                    ? "1994-08-17"
                                    : textEditingTglLahir.text,
                                address: textEditingAlamat.text.isEmpty
                                    ? "Jl. Jend. Sudirman"
                                    : textEditingAlamat.text,
                                provinceId: basket['idProvince'] ?? 7,
                                regencyId: basket['idCity'] ?? 65,
                                subdistrictId: basket['idSubdistrict'] ?? 770,
                                urbanVillageId:
                                    basket['idUrbanVillage'] ?? 11182,
                                city: textEditingKota.text.isEmpty
                                    ? "Daerah Khusus Ibukota Jakarta"
                                    : textEditingKota.text,
                                professionId: basket['idProfesi'] == null
                                    ? 1
                                    : int.parse(basket['idProfesi'].toString()),
                      ...
                      if (validates()) {
                        if (_gender == null) {
                          flushbarError('Jenis kelamin tidak boleh kosong')
                              .show(context);
                        } else {
                          String convertHp = "";
                          if (textEditingKodeReferral.text.isNotEmpty) {
