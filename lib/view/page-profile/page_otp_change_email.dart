...
class OTPChangeEmailPage extends StatefulWidget {
  final String? email;
  const OTPChangeEmailPage({Key? key, @required this.email}) : super(key: key);
                        ...
                        if (value['status'] == 1) {
                          ...
                          Navigator.push(context,
                            ...
                            return const SuccessStateWidget(
                                ...
                                title: 'Email diubah',
                                content:
                                    'Selamat email kamu berhasil di rubah');
                          }));
                        } else {
                          setState(() {
                            _isLoading = true;
                ...
                : _start == 0
                    ? GestureDetector(
                        onTap: () {
                          ...
                          singleUserApi
                              .postUpdateEmailResend(widget.email!)
                              .then((value) {
                            if (value['status'] == 1) {
                              setState(() {
